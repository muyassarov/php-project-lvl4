...
@section('content')
    ...
    {{ Form::bsSelect('assigned_to_id', $users, $task->assigned_to_id, __('forms.task.edit.assigned-to-label'), ['placeholder' => __('forms.task.edit.assigned-to-placeholder')]) }}
    {{ Form::bsSelect('labels[]', $labels, $task->labels->pluck('id'), __('forms.task.edit.labels-label'), ['multiple', 'placeholder' => __('forms.task.edit.labels-placeholder')]) }}
    {{ link_to_route('tasks.index', __('forms.task.edit.back'), [], ['class' => 'btn btn-lg btn-secondary']) }}
    {{ Form::submit(__('forms.task.edit.submit'), ['class' => 'btn btn-primary btn-lg']) }}
    {{ Form::close() }}
@endsection
