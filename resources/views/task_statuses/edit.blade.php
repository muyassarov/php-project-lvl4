...
@section('content')
    ...
    <div class="form-group">
        {{ Form::label('name', __('forms.task-status.edit.name-label')) }}
        {{ Form::text('name', $taskStatus->name, ['class' => 'form-control', 'placeholder' => __('forms.task-status.edit.name-placeholder'), 'required', 'autofocus']) }}
    </div>
