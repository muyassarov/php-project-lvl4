...
@section('content')
    ...
    {{ link_to_route('task_statuses.index', __('forms.task-status.edit.back'), [], ['class' => 'btn btn-lg btn-secondary']) }}
    {{ Form::submit(__('forms.task-status.edit.submit'), ['class' => 'btn btn-primary btn-lg']) }}
    {{ Form::close() }}
@endsection
